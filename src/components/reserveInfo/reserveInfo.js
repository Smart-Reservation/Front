...
const information = {
  store: {
    ...
    imgUrl:
      "https://recipe1.ezmember.co.kr/cache/recipe/2021/10/26/8f82be9c22ec2f4f9ab25363cc611b141.jpg",
    store_name: "미식성",
    Location: "광운대 앞",
    deposit: 12,
  },
  ...
  return (
    <div>
      <UpperInfo>
        ...
        <div>
          <p>
            <span>Store</span> : {store.store_name}
          </p>
          <p>
            <span>Location </span>: {store.Location}
          </p>
          <p>
          ...
          <p>
            <span>Date:</span>
            {information.dateInfo.date} <span>Day:</span>
            {information.dateInfo.time}
          </p>
        </div>
      </UpperInfo>
      <DownInfo>
        ...
        <p>
          ...
          {information.dateInfo.man}
        </p>
        <p>
          <span>totle: </span>
          {information.dateInfo.man * store.deposit}BNB
        </p>
      </DownInfo>
    </div>
  );
